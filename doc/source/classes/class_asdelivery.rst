...
Delivers the payload of an :ref:`ASPackage<class_ASPackage>` to the target component. Automatically dispatches ``ASEventTag``\ s defined in the package upon successful delivery.
