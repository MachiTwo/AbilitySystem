...
- `void dispatch_event(const ASEventTag& p_data)`: Roteia um evento arbitário e o insere no historical buffer.
- `Vector<ASEventTagHistoricalEntry> _event_history`: Buffer circular para persistência de curto prazo.
