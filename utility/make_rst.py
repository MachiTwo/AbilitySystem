...
def make_rst_class(
    ...
    with open(
        ...
        if not writing_translation:  # Skip for translations to reduce diff.
            ...
            source_github_url = f"https://github.com/MachiTwo/AbilitySystem/tree/{git_branch}/{source_xml_path}"
            generator_github_url = f"https://github.com/MachiTwo/AbilitySystem/tree/{git_branch}/utility/make_rst.py"
